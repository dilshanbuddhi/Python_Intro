...
def parse_weather_data(data):
 #{'latitude': 52.52, 'longitude': 13.419998, 'generationtime_ms': 0.030517578125, 'utc_offset_seconds': 0, 'timezone': 'GMT', 'timezone_abbreviation': 'GMT', 'elevation': 38.0, 'current_units': {'time': 'iso8601', 'interval': 'seconds', 'temperature_2m': '°C'}, 'current': {'time': '2025-07-30T10:00', 'interval': 900, 'temperature_2m': 20.4}}
